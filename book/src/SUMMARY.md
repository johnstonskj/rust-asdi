...
6. [Appendix: Datalog EBNF](reference/datalog_ebnf.md)
7. [Appendix: Relational Algebra Mapping](reference/relational.md)
   1. [Relational Algebra EBNF](reference/relational_ebnf.md)
8. [Appendix: Horn Clause Mapping](reference/logic.md)
